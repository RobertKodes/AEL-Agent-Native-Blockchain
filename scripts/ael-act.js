...
const [action,payloadText]=process.argv.slice(2),baseUrl=process.env.AEL_URL??'https://ael-network.onrender.com',actorId=process.env.AEL_ACTOR_ID,keyPath=process.env.AEL_ACTOR_KEY;
